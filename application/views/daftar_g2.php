...
$t_inv_mst_tipe=array(
    'TANAHBANGUNAN'=>'TANAH DAN BANGUNAN'
);
					...
					<div id="isiSatu" class="accordion-collapse collapse show" data-bs-parent="#frmkryDet1" aria-labelledby="judulSatu">
						<div class="accordion-body">
							<table class="table table-lg table-borderless">
								<?php 
									echo form_open("klik_g/tambah_aktiva_g2_ok","",$formulir_prm);
								?> 	 
								<tbody>
									<tr>
									...
									<tr>
										<td class="col-md-3">POS REKENING TANAH<?php echo form_dropdown($formulir_rek); ?>
										<td class="col-md-3">TGL JATUH TEMPO HGB/HGU/HPL<?php echo form_input($formulir_tgljtphak); ?></td>
									</tr>
									<tr>
		...
		success: function(data){
			...
			$.each(data,function(key,value){
				$('#hasilajax').append(
					...
					"<tr><td>JATUH TEMPO KEPEMILIKAN (HGB/HGU/HPL) </td><td>"+value.invjthtmp2+"</td></tr>"+
