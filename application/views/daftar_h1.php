...
$t_inv_mst_tipe=array(
	''=>'Pilih tipe inventaris...',
    'RODA2'=>'KENDARAAN RODA 2',
					...
					<div id="isiSatu" class="accordion-collapse collapse show" data-bs-parent="#frmkryDet1" aria-labelledby="judulSatu">
						<div class="accordion-body">
							<table class="table table-lg table-borderless">
								<?php 
									echo form_open("klik_g/tambah_aktiva_g1_ok","",$formulir_prm);
								?> 	 
								<tbody>
									<tr>
									...
									<tr>
										<td class="col-md-3">NO.POLISI<?php echo form_input($formulir_kode); ?></td>
									...
									<tr>
										...
										<td class="col-md-3">MASA PAKAI (BULAN)<?php echo form_input($formulir_masa); ?></td>
									</tr>
									<tr>
									...
									<tr>
										<td class="col-md-3">POS REKENING KENDARAAN<?php echo form_dropdown($formulir_rek); ?>
										<td class="col-md-3">TGL JATUH TEMPO STNK<?php echo form_input($formulir_tgljtpstnk); ?></td>
									</tr>
									<tr>
										<td class="col-md-3">POS REKENING PENYUSUTAN<?php echo form_dropdown($formulir_rek_sst); ?></td>
										<td class="col-md-3">TGL JATUH TEMPO PAJAK<?php echo form_input($formulir_tgljtppajak); ?></td>
									</tr>
									<tr>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url().'index.php/klik_g/ubah_aktiva_g1_ok/'.$im->invprm ?>" class="btn btn-outline-dark btn-sm">UBAH</a>
											<a href="<?php echo base_url().'index.php/klik_g/hapus_aktiva_g1_ok/'.$im->invprm ?>" class="btn btn-outline-dark btn-sm">HAPUS</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
...
$("#t_inv_mst_tipe").change(function(){
        var pilih_t_inv_mst_tipe=$("#t_inv_mst_tipe option:selected").val();
			if(pilih_t_inv_mst_tipe != ""){
				$("#t_inv_mst_masa").empty();
				$("#t_inv_mst_masa").prop("readonly",true);
				if(pilih_t_inv_mst_tipe == "RODA2"){
					$("#t_inv_mst_masa").val("48");
				} else {
					$("#t_inv_mst_masa").val("96");
				}
			} else {
				$("#t_inv_mst_masa").empty();
				$("#t_inv_mst_masa").prop("readonly",true);
		...
		success: function(data){
			...
			$.each(data,function(key,value){
				$('#hasilajax').append(
					...
					"<tr><td>NOMOR POLISI </td><td>"+value.invkode+"</td></tr>"+
					"<tr><td>ATAS NAMA STNK </td><td>"+value.invnm+"</td></tr>"+
					"<tr><td>KEPEMILIKAN </td><td>"+value.invpemilik+"</td></tr>"+
					"<tr><td>JATUH TEMPO PAJAK </td><td>"+value.invjthtmp1+"</td></tr>"+
					...
					"<tr><td>NILAI AKTIVA </td><td>"+value.invakhir+"</td></tr>"
					);
			})
